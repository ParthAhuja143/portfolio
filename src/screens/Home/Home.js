				...
				<div className='main' data-scroll-container ref={(el) => (scrollContainer = el)} >
					...
					<div className = 'main_title' data-scroll data-scroll-sticky>
						<div className = 'main_hello'>
							<div className = 'main_helloInner'>I am <span style = {{fontFamily : "Uncial Antiqua"}}>PARTHAHUJA</span></div>
							<div className = 'main_helloInner'>Web Dev & Designer</div>
							<div className = 'main_helloInner'>based in India</div>
						</div>
					...
					<div className = 'aboutMe'>
						...
						<div className = 'aboutMe_container'>
							...
							<div className = 'who'>
								...
								<div className ='who_desc'>
									...
									<div className = 'who_desc_subtitle'>
										...
										<p>
											<strong>
												I am a student from Delhi ,freelance designer and full stack developer. I have experience building custom websites. My zeal for improvement allows me to reinvent myself in every project and provide an innovative and creative result every time.
											</strong>
										</p>
									</div>
								</div>
							...
							<h2 className = 'aboutMe_desc'>
								<div className = 'aboutMe_desc1'>I’m an indian web/app developer,</div>
						...
						<div className = 'p_container'>
							<div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => handleMouseOverSocialIcon()} onMouseLeave={() => handleMouseLeaveSocialIcon()} onClick = {() => {openProject("https://app.inspekthor.com/")}} onTouchStart = {() => {openProject("https://app.inspekthor.com/")}}><FontAwesomeIcon icon = {faLink} /></div>
								</div>
							...
							<div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => handleMouseOverSocialIcon()} onMouseLeave={() => handleMouseLeaveSocialIcon()} onClick = {() => {openProject("https://app.inspekthor.com/detekthor/login")}} onTouchStart = {() => {openProject("https://app.inspekthor.com/detekthor/login")}}><FontAwesomeIcon icon = {faLink} /></div>
								</div>
								<div className = 'project_footer'>
									<HostedLink/>
								</div>
							...
							<div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => {handleMouseOverSocialIcon()}} onMouseLeave={() => {handleMouseLeaveSocialIcon()}} onClick = {() => {openProject("https://demo.vanimeetings.com/")}} onTouchStart = {() => {openProject("https://demo.vanimeetings.com/")}}><FontAwesomeIcon icon = {faLink} /></div>
								</div>
								<div className = 'project_footer'>
									<HostedLink/>
									<MobileResponsive/>
							 ...
							 <div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => {handleMouseOverSocialIcon()}} onMouseLeave={() => {handleMouseLeaveSocialIcon()}} onClick = {() => {openProject("https://spotifybyparth.netlify.app/")}} onTouchStart = {() => {openProject("https://spotifybyparth.netlify.app/")}}><FontAwesomeIcon icon = {faLink} /></div>
								</div>
								<div className = 'project_footer'>
									<HostedLink/>
									<MobileResponsive/>
							...
							<div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => {handleMouseOverSocialIcon()}} onMouseLeave={() => {handleMouseLeaveSocialIcon()}} onClick = {() => {openProject("https://hopeful-bell-35b015.netlify.app/")}} onTouchStart = {() => {openProject("https://hopeful-bell-35b015.netlify.app/")}}><FontAwesomeIcon icon = {faLink} /></div>
								</div>
								<div className = 'project_footer'>
									<HostedLink/>
									<MobileResponsive/>
							...
							<div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => {handleMouseOverSocialIcon()}} onMouseLeave={() => {handleMouseLeaveSocialIcon()}} onClick = {() => {openProject("https://expense-tracker-by-parth.netlify.app/")}} onTouchStart = {() => {openProject("https://expense-tracker-by-parth.netlify.app/")}}><FontAwesomeIcon icon = {faLink} /></div>
								</div>
								<div className = 'project_footer'>
									<HostedLink/>
									<MobileResponsive/>
							...
							<div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => {handleMouseOverSocialIcon()}} onMouseLeave={() => {handleMouseLeaveSocialIcon()}} onClick = {() => {openProject("https://github.com/ParthAhuja143/E-Commerce-Website")}} onTouchStart = {() => {openProject("https://github.com/ParthAhuja143/E-Commerce-Website")}}><FontAwesomeIcon icon = {faLink} /></div>
								</div>
								<div className = 'project_footer'>
									<GithubLink/>
								</div>
							...
							<div className = 'project'>
								<div className = 'project_container'>
									...
									<div className = 'project_sno' onMouseOver={() => {handleMouseOverSocialIcon()}} onMouseLeave={() => {handleMouseLeaveSocialIcon()}} onClick = {() => {openProject("https://social-media-by-parth.netlify.app/")}} onTouchStart = {() => {openProject("https://social-media-by-parth.netlify.app/")}} ><FontAwesomeIcon icon = {faLink} /></div>
								</div>
								<div className = 'project_footer'>
									<HostedLink/>
									<GithubLink/>
